 ...
 */
class getPorfolioControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\PorfolioController' shared autowired service.
     *
     * @return \App\Controller\PorfolioController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/PorfolioController.php';

        $container->services['App\\Controller\\PorfolioController'] = $instance = new \App\Controller\PorfolioController();
        ...
        ]))->withContext('App\\Controller\\PorfolioController', $container));
